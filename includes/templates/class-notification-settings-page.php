...
class Notification_Settings_Page extends User_Account_Page {
	...
	public function __construct( $args = [] ) {
		...
		// reveals it only where the browser supports push.
		if ( hivepress()->notification_push && hivepress()->notification_push->is_enabled() && ! hivepress()->notification_push->get_keys() ) {
